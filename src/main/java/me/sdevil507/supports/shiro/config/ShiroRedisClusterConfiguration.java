 ...
 * @since 1.7
 */
public class ShiroRedisClusterConfiguration extends RedisClusterConfiguration {

    private static final String REDIS_CLUSTER_NODES_CONFIG_PROPERTY = "shiro.redis.cluster.nodes";
    private static final String REDIS_CLUSTER_MAX_REDIRECTS_CONFIG_PROPERTY = "shiro.redis.cluster.max-redirects";
     ...
     */
    public ShiroRedisClusterConfiguration() {
     ...
     */
    public ShiroRedisClusterConfiguration(Collection<String> clusterNodes) {
     ...
     */
    public ShiroRedisClusterConfiguration(PropertySource<?> propertySource) {
     ...
     */
    @Override
    public ShiroRedisClusterConfiguration clusterNode(RedisNode node) {
     ...
     */
    @Override
    public ShiroRedisClusterConfiguration clusterNode(String host, Integer port) {
